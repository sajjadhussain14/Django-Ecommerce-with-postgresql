...
const update_billing = (csrfToken) => {
  ...
  let billing_address_line1 = document.getElementById(
    "billing_address_line1",
  ).value;
  let billing_address_line2 = document.getElementById(
...
const update_shipping = (csrfToken) => {
  ...
  let shipping_first_name = document.getElementById(
    "shipping_first_name",
  ).value;
  ...
  let shipping_address_line1 = document.getElementById(
    "shipping_address_line1",
  ).value;
  let shipping_address_line2 = document.getElementById(
